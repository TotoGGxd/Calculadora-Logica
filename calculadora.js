...
function crearTabla() {
    if (tableStatement !== "" && tableStatement.length !== 0) {
        ...
        ventana = window.open('', 'ventana', 'width=800,height=600,top=' + ((screen.height - 550) / 2) + ',left=' + ((screen.width - 900) / 2));
        ventana.document.write('<head><title>Tabla lógica proposicional</title><link href="styles.css" rel="stylesheet" type="text/css"></head>');
        ventana.document.write('<body bgcolor="black" class="tabla-generada">');
        ventana.document.write('<style>');
        ventana.document.write('*{font-family: "helvetica";}');
        ventana.document.write('table, th, td {border: .5px solid white;width:100px;color="white;"}');
        ...
        ventana.document.write('<caption class="titulo-tabla"><label><strong><font color="white" size="4px" letter-spacing=".75rem">Tabla lógica proposicional</font></strong></label><br></caption>');
